...
/**
 * @title AgriTrust
 * @dev Main contract for agricultural marketplace with auctions and direct sales
 */
contract AgriTrust is ReentrancyGuard, Ownable {
    ...
    mapping(uint256 => uint256) public cropToAuction; // cropId => auctionId
    ...
    /**
     * @dev Emergency function to deactivate a crop (only owner)
     */
